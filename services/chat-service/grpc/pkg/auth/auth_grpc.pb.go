...
type AuthServiceClient interface {
	HashPassword(ctx context.Context, in *HashPasswordReq, opts ...grpc.CallOption) (*HashPasswordRes, error)
...
func (c *authServiceClient) HashPassword(ctx context.Context, in *HashPasswordReq, opts ...grpc.CallOption) (*HashPasswordRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HashPasswordRes)
...
type AuthServiceServer interface {
	HashPassword(context.Context, *HashPasswordReq) (*HashPasswordRes, error)
...
func (UnimplementedAuthServiceServer) HashPassword(context.Context, *HashPasswordReq) (*HashPasswordRes, error) {
...
func _AuthService_HashPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).HashPassword(ctx, req.(*HashPasswordReq))
	}
