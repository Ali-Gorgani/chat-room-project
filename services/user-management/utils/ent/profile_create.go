...
func (pc *ProfileCreate) SetProfilePicture(s string) *ProfileCreate {
	pc.mutation.SetProfilePicture(s)
	return pc
}

// SetNillableProfilePicture sets the "profile_picture" field if the given value is not nil.
func (pc *ProfileCreate) SetNillableProfilePicture(s *string) *ProfileCreate {
	if s != nil {
		pc.SetProfilePicture(*s)
	}
	return pc
}
...
func (pc *ProfileCreate) createSpec() (*Profile, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.ProfilePicture(); ok {
